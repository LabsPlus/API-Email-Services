const UpdateEmailRecoveryMessage = {
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        <div style="text-align: center; border-bottom: 1px solid #dddddd; padding-bottom: 20px; margin-bottom: 20px;">
            <h1 style="margin: 0; color: #333333;">Confirmação de Alteração de Email de Recuperação</h1>
        </div>
        <div style="text-align: center;">
            <p style="font-size: 16px; color: #555555; line-height: 1.5;">Olá, ${nome}</p>
            <p style="font-size: 16px; color: #555555; line-height: 1.5;">Recebemos uma solicitação para alterar o seu endereço de email recuperação de senha. Para confirmar essa alteração, clique no link abaixo:</p>
...
export { UpdateEmailRecoveryMessage };