const ReactivateProfileMessage = {
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        <div style="text-align: center; border-bottom: 1px solid #dddddd; padding-bottom: 20px; margin-bottom: 20px;">
            <h1 style="margin: 0; color: #333333;">Solicitação de Exclusão Cancelada</h1>
        </div>
        <div style="text-align: center;">
            <p style="font-size: 16px; color: #555555; line-height: 1.5;">Olá, ${name}</p>
            <p style="font-size: 16px; color: #555555; line-height: 1.5;">Viemos informar que a solicitação de exclusão foi cancelada e que seu perfil foi reativado.</p>
